...
function Register() {
    ...
    const {user, isLoadging, isError, isSuccess, message} = useSelector(state => state.auth)
        ...
        <section className='form'>
            <form onSubmit={onSubmit}>
                ...
                <div className="form-group">
                    ...
                    value={password} onChange={onChange} placeholder='Enter your passsword' required/>
                </div>
                <div className="form-group">
